#' Simulate data from the categorical spatial mark resight model with detection function parameters that vary by ID covariate
#' @description Will document after I defend. Should be able to get the idea in the example found in the mcmc.conCatSMR.ID.df help file.
