...
calclamd3D <- function(lam0, sigma, D) {
    .Call('SPIM_calclamd3D', PACKAGE = 'SPIM', lam0, sigma, D)
}

calclamd2D <- function(lam0, sigma, D, idx) {
    .Call('SPIM_calclamd2D', PACKAGE = 'SPIM', lam0, sigma, D, idx)
}

OpenSCRlik <- function(z, lamd, y, K, Xidx) {
    .Call('SPIM_OpenSCRlik', PACKAGE = 'SPIM', z, lamd, y, K, Xidx)
}

sum_ll_y <- function(z, ll_y, Xidx) {
    .Call('SPIM_sum_ll_y', PACKAGE = 'SPIM', z, ll_y, Xidx)
}

sum_ll_y_t <- function(z, ll_y, Xidx) {
    .Call('SPIM_sum_ll_y_t', PACKAGE = 'SPIM', z, ll_y, Xidx)
}

updateDfun3D <- function(lam0, sigma, lamd, y, z, Xidx, K, D) {
    .Call('SPIM_updateDfun3D', PACKAGE = 'SPIM', lam0, sigma, lamd, y, z, Xidx, K, D)
}

upZ <- function(z, a, knownmatrix, Xidx, y, pd, K, Ez, gamma, gammaprime, phi, psi, N, maxJ, propz, propgamma) {
    .Call('SPIM_upZ', PACKAGE = 'SPIM', z, a, knownmatrix, Xidx, y, pd, K, Ez, gamma, gammaprime, phi, psi, N, maxJ, propz, propgamma)
}

mcmc_Open <- function(lam0, sigma, gamma, gammaprime, phi, D, lamd, y, z, a, s1, s2, metamu, useverts, vertices, xlim, ylim, knownmatrix, Xidx, Xcpp, K, Ez, psi, N, proplam0, propsig, propz, propgamma, props1x, props1y, props2x, props2y, propsigma_t, sigma_t, niter, nburn, nthin, npar, each) {
    .Call('SPIM_mcmc_Open', PACKAGE = 'SPIM', lam0, sigma, gamma, gammaprime, phi, D, lamd, y, z, a, s1, s2, metamu, useverts, vertices, xlim, ylim, knownmatrix, Xidx, Xcpp, K, Ez, psi, N, proplam0, propsig, propz, propgamma, props1x, props1y, props2x, props2y, propsigma_t, sigma_t, niter, nburn, nthin, npar, each)
}
