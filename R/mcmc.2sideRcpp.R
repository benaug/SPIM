#' Spatial partial identity MCMC algorithm in Rcpp
...
#' @param keepACs logical indicating whether or not you want to record the posteriors for s, z, ID_L, and ID_R
...
#'a=Sys.time()
#'store=mcmc.2sideRcpp(data,niter=niter,nburn=nburn,nthin=nthin, M = 100,inits=inits,swap=10)
#'b=Sys.time()
#'b-a
#'#plot posteriors
#'par(mfrow=c(2,2))
