...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(inoutCppOpen(sx, sy, vertices));
    return __result;
END_RCPP
}
// calclamd3D
arma::cube calclamd3D(NumericVector lam0, NumericVector sigma, arma::cube D);
RcppExport SEXP SPIM_calclamd3D(SEXP lam0SEXP, SEXP sigmaSEXP, SEXP DSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    __result = Rcpp::wrap(calclamd3D(lam0, sigma, D));
    return __result;
END_RCPP
}
// calclamd2D
arma::mat calclamd2D(NumericVector lam0, NumericVector sigma, arma::cube D, int idx);
RcppExport SEXP SPIM_calclamd2D(SEXP lam0SEXP, SEXP sigmaSEXP, SEXP DSEXP, SEXP idxSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type lam0(lam0SEXP);
    ...
    __result = Rcpp::wrap(calclamd2D(lam0, sigma, D, idx));
    return __result;
END_RCPP
}
// OpenSCRlik
arma::cube OpenSCRlik(IntegerMatrix z, arma::cube lamd, arma::cube y, NumericVector K, NumericVector Xidx);
RcppExport SEXP SPIM_OpenSCRlik(SEXP zSEXP, SEXP lamdSEXP, SEXP ySEXP, SEXP KSEXP, SEXP XidxSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    __result = Rcpp::wrap(OpenSCRlik(z, lamd, y, K, Xidx));
    return __result;
END_RCPP
}
// sum_ll_y
double sum_ll_y(IntegerMatrix z, arma::cube ll_y, NumericVector Xidx);
RcppExport SEXP SPIM_sum_ll_y(SEXP zSEXP, SEXP ll_ySEXP, SEXP XidxSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< IntegerMatrix >::type z(zSEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type Xidx(XidxSEXP);
    __result = Rcpp::wrap(sum_ll_y(z, ll_y, Xidx));
    return __result;
END_RCPP
}
// sum_ll_y_t
NumericVector sum_ll_y_t(IntegerMatrix z, arma::cube ll_y, NumericVector Xidx);
RcppExport SEXP SPIM_sum_ll_y_t(SEXP zSEXP, SEXP ll_ySEXP, SEXP XidxSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< IntegerMatrix >::type z(zSEXP);
    Rcpp::traits::input_parameter< arma::cube >::type ll_y(ll_ySEXP);
    Rcpp::traits::input_parameter< NumericVector >::type Xidx(XidxSEXP);
    __result = Rcpp::wrap(sum_ll_y_t(z, ll_y, Xidx));
    return __result;
END_RCPP
}
// updateDfun3D
List updateDfun3D(NumericVector lam0, NumericVector sigma, arma::cube lamd, arma::cube y, IntegerMatrix z, NumericVector Xidx, NumericVector K, arma::cube D);
RcppExport SEXP SPIM_updateDfun3D(SEXP lam0SEXP, SEXP sigmaSEXP, SEXP lamdSEXP, SEXP ySEXP, SEXP zSEXP, SEXP XidxSEXP, SEXP KSEXP, SEXP DSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type lam0(lam0SEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type K(KSEXP);
    Rcpp::traits::input_parameter< arma::cube >::type D(DSEXP);
    __result = Rcpp::wrap(updateDfun3D(lam0, sigma, lamd, y, z, Xidx, K, D));
    return __result;
END_RCPP
}
// mcmc_Open
List mcmc_Open(NumericVector lam0, NumericVector sigma, NumericVector gamma, NumericVector gammaprime, NumericVector phi, arma::cube D, arma::cube lamd, arma::cube y, IntegerMatrix z, IntegerMatrix a, NumericMatrix s1, arma::cube s2, bool metamu, bool useverts, NumericMatrix vertices, NumericVector xlim, NumericVector ylim, IntegerMatrix knownmatrix, NumericVector Xidx, arma::cube Xcpp, NumericVector K, NumericMatrix Ez, double psi, IntegerVector N, NumericVector proplam0, NumericVector propsig, NumericVector propz, NumericVector propgamma, double props1x, double props1y, double props2x, double props2y, double propsigma_t, NumericVector sigma_t, int niter, int nburn, int nthin, int npar, NumericVector each);
RcppExport SEXP SPIM_mcmc_Open(SEXP lam0SEXP, SEXP sigmaSEXP, SEXP gammaSEXP, SEXP gammaprimeSEXP, SEXP phiSEXP, SEXP DSEXP, SEXP lamdSEXP, SEXP ySEXP, SEXP zSEXP, SEXP aSEXP, SEXP s1SEXP, SEXP s2SEXP, SEXP metamuSEXP, SEXP usevertsSEXP, SEXP verticesSEXP, SEXP xlimSEXP, SEXP ylimSEXP, SEXP knownmatrixSEXP, SEXP XidxSEXP, SEXP XcppSEXP, SEXP KSEXP, SEXP EzSEXP, SEXP psiSEXP, SEXP NSEXP, SEXP proplam0SEXP, SEXP propsigSEXP, SEXP propzSEXP, SEXP propgammaSEXP, SEXP props1xSEXP, SEXP props1ySEXP, SEXP props2xSEXP, SEXP props2ySEXP, SEXP propsigma_tSEXP, SEXP sigma_tSEXP, SEXP niterSEXP, SEXP nburnSEXP, SEXP nthinSEXP, SEXP nparSEXP, SEXP eachSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type lam0(lam0SEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type each(eachSEXP);
    __result = Rcpp::wrap(mcmc_Open(lam0, sigma, gamma, gammaprime, phi, D, lamd, y, z, a, s1, s2, metamu, useverts, vertices, xlim, ylim, knownmatrix, Xidx, Xcpp, K, Ez, psi, N, proplam0, propsig, propz, propgamma, props1x, props1y, props2x, props2y, propsigma_t, sigma_t, niter, nburn, nthin, npar, each));
    return __result;
END_RCPP
}
// inoutCpp
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type sy(sySEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type vertices(verticesSEXP);
    __result = Rcpp::wrap(inoutCpp(sx, sy, vertices));
    return __result;
END_RCPP
}
// SCRlik
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(SCRlik(z, lamd, y, K));
    return __result;
END_RCPP
}
// calclamd
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(calclamd(lam, sigma, D));
    return __result;
END_RCPP
}
// updateDfun
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type D(DSEXP);
    __result = Rcpp::wrap(updateDfun(lam0, sigma, lamd, y, z, X, K, D));
    return __result;
END_RCPP
}
// updatePsi
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< double >::type psi(psiSEXP);
    __result = Rcpp::wrap(updatePsi(z, knownvector, lamd, y, X, K, psi));
    return __result;
END_RCPP
}
// updateACs
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type useverts(usevertsSEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type vertices(verticesSEXP);
    __result = Rcpp::wrap(updateACs(z, s, xlim, ylim, D, lamd, lam0, sigma, y, X, K, useverts, vertices));
    return __result;
END_RCPP
}
// MCMC1
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nburn(nburnSEXP);
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    __result = Rcpp::wrap(MCMC1(lam0, sigma, y, z, X, K, D, knownvector, s, psi, xlim, ylim, useverts, vertices, proplam0, propsigma, propsx, propsy, niter, nburn, nthin));
    return __result;
END_RCPP
}
// SCRliktf
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type y(ySEXP);
    Rcpp::traits::input_parameter< NumericVector >::type K(KSEXP);
    __result = Rcpp::wrap(SCRliktf(z, lamd, y, K));
    return __result;
END_RCPP
}
// MCMC1tf
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nburn(nburnSEXP);
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    __result = Rcpp::wrap(MCMC1tf(lam0, sigma, y, z, X, K, D, knownvector, s, psi, xlim, ylim, useverts, vertices, proplam0, propsigma, propsx, propsy, niter, nburn, nthin));
    return __result;
END_RCPP
}
// fulllik
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllik(z, lamd1, lamd2, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// updateparms
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type D(DSEXP);
    __result = Rcpp::wrap(updateparms(lam01, lam02, sigma, lamd1, lamd2, yboth, yleft, yright, z, X, K, D));
    return __result;
END_RCPP
}
// swapC
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type likcurr(likcurrSEXP);
    __result = Rcpp::wrap(swapC(z, Nfixed, ID_L, ID_R, s, swap, swaptol, lamd1, lamd2, yboth, yleft, yright, X, K, left, right, likcurr));
    return __result;
END_RCPP
}
// updatePsi2
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< IntegerVector >::type z(zSEXP);
    Rcpp::traits::input_parameter< LogicalVector >::type zeroguys(zeroguysSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type knownvector(knownvectorSEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type lamd1(lamd1SEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type lamd2(lamd2SEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type yboth(ybothSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< double >::type psi(psiSEXP);
    __result = Rcpp::wrap(updatePsi2(z, zeroguys, knownvector, lamd1, lamd2, yboth, yleft, yright, X, K, psi));
    return __result;
END_RCPP
}
// updateACs2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(updateACs2(z, s, xlim, ylim, useverts, vertices, D, lamd1, lamd2, lam01, lam02, sigma, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// MCMC
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(MCMC(lam01, lam02, sigma, yboth, yleft, yright, z, X, K, D, Nfixed, knownvector, ID_L, ID_R, swap, swaptol, left, right, s, psi, xlim, ylim, useverts, vertices, proplam01, proplam02, propsigma, propsx, propsy, niter, nburn, nthin, updates));
    return __result;
END_RCPP
}
// fullliktf
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(fullliktf(z, lamd1, lamd2, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// MCMCtf
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    Rcpp::traits::input_parameter< LogicalVector >::type updates(updatesSEXP);
    __result = Rcpp::wrap(MCMCtf(lam01, lam02, sigma, yboth, yleft, yright, z, X, K, Kmax, D, Nfixed, knownvector, ID_L, ID_R, swap, swaptol, left, right, s, psi, xlim, ylim, useverts, vertices, proplam01, proplam02, propsigma, propsx, propsy, niter, nburn, nthin, updates));
    return __result;
END_RCPP
}
// fullliktf2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type lamd1(lamd1SEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type lamd2(lamd2SEXP);
    Rcpp::traits::input_parameter< arma::cube >::type ybothC(ybothCSEXP);
    Rcpp::traits::input_parameter< arma::cube >::type yleftC(yleftCSEXP);
    Rcpp::traits::input_parameter< arma::cube >::type yrightC(yrightCSEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< IntegerMatrix >::type tf(tfSEXP);
    __result = Rcpp::wrap(fullliktf2(z, lamd1, lamd2, ybothC, yleftC, yrightC, X, tf));
    return __result;
END_RCPP
}
// MCMCtf2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    Rcpp::traits::input_parameter< LogicalVector >::type updates(updatesSEXP);
    __result = Rcpp::wrap(MCMCtf2(lam01, lam02, sigma, yboth, yleft, yright, z, X, tf, D, Nfixed, knownvector, ID_L, ID_R, swap, swaptol, left, right, s, psi, xlim, ylim, useverts, vertices, proplam01, proplam02, propsigma, propsx, propsy, niter, nburn, nthin, updates));
    return __result;
END_RCPP
}
// fulllikInd
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(fulllikInd(z1, z2, lamd11, lamd21, lamd12, lamd22, yboth, yleft, yright, X, K, Nknown));
    return __result;
END_RCPP
}
// fulllikInd1D
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllikInd1D(z1, z2, nth, Nfixed, lamd11, lamd21, lamd12, lamd22, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// updateparmsInd
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type Nfixed(NfixedSEXP);
    __result = Rcpp::wrap(updateparmsInd(lam01, lam02, sigma, lamd11, lamd21, lamd12, lamd22, yboth, yleft, yright, z1, z2, X, K, D1, D2, Nfixed));
    return __result;
END_RCPP
}
// updatePsiInd
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type Nfixed(NfixedSEXP);
    __result = Rcpp::wrap(updatePsiInd(z1, z2, capvector1, capvector2, lamd11, lamd12, lamd21, lamd22, yboth, yleft, yright, X, K, psi1, psi2, Nfixed));
    return __result;
END_RCPP
}
// updateACsInd
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< int >::type Nfixed(NfixedSEXP);
    __result = Rcpp::wrap(updateACsInd(z1, z2, s1, s2, xlim, ylim, useverts, vertices, D1, D2, lamd11, lamd21, lamd12, lamd22, lam01, lam02, sigma, yboth, yleft, yright, X, K, Nfixed));
    return __result;
END_RCPP
}
// MCMCInd
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    Rcpp::traits::input_parameter< LogicalVector >::type updates(updatesSEXP);
    __result = Rcpp::wrap(MCMCInd(lam01, lam02, sigma, yboth, yleft, yright, z1, z2, X, K, D1, D2, Nfixed, capvector1, capvector2, s1, s2, psi1, psi2, xlim, ylim, useverts, vertices, proplam01, proplam02, propsigma, propsx, propsy, niter, nburn, nthin, updates));
    return __result;
END_RCPP
}
// fulllikInd2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllikInd2(z1, z2, lamdL, lamdR, yleft, yright, X, K));
    return __result;
END_RCPP
}
// fulllikInd1D2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllikInd1D2(z1, z2, lamdL, lamdR, yleft, yright, X, K));
    return __result;
END_RCPP
}
// updateparmsInd2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type D1(D1SEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type D2(D2SEXP);
    __result = Rcpp::wrap(updateparmsInd2(lam01, sigma, lamdL, lamdR, yleft, yright, z1, z2, X, K, D1, D2));
    return __result;
END_RCPP
}
// updatePsiInd2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type psi1(psi1SEXP);
    Rcpp::traits::input_parameter< double >::type psi2(psi2SEXP);
    __result = Rcpp::wrap(updatePsiInd2(z1, z2, capvector1, capvector2, lamdL, lamdR, yleft, yright, X, K, psi1, psi2));
    return __result;
END_RCPP
}
// updateACsInd2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(updateACsInd2(z1, z2, s1, s2, xlim, ylim, D1, D2, lamdL, lamdR, lam01, sigma, yleft, yright, X, K));
    return __result;
END_RCPP
}
// MCMCInd2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nburn(nburnSEXP);
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    __result = Rcpp::wrap(MCMCInd2(lam01, sigma, yleft, yright, z1, z2, X, K, D1, D2, capvector1, capvector2, s1, s2, psi1, psi2, xlim, ylim, useverts, vertices, proplam01, propsigma, propsx, propsy, niter, nburn, nthin));
    return __result;
END_RCPP
}
// fulllikInd3
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllikInd3(z1, z2, z3, lamdB, lamdL, lamdR, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// fulllikInd1D3
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    __result = Rcpp::wrap(fulllikInd1D3(z1, z2, z3, lamdB, lamdL, lamdR, yboth, yleft, yright, X, K));
    return __result;
END_RCPP
}
// MCMCInd3
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nburn(nburnSEXP);
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    __result = Rcpp::wrap(MCMCInd3(lam01, lam02, sigma, yboth, yleft, yright, z1, z2, z3, X, K, D1, D2, D3, capvector1, capvector2, capvector3, s1, s2, s3, psi1, psi2, psi3, xlim, ylim, useverts, vertices, proplam01, proplam02, propsigma, propsx, propsy, niter, nburn, nthin));
    return __result;
END_RCPP
}
// upbeta
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type z(zSEXP);
    __result = Rcpp::wrap(upbeta(beta0, beta1, grid, scell, propbeta0, propbeta1, EN, N, cellArea, z));
    return __result;
END_RCPP
}
// MCMC1b
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nburn(nburnSEXP);
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    __result = Rcpp::wrap(MCMC1b(lam0, sigma, beta0, beta1, y, z, X, K, D, N, knownvector, s, scell, psi, grid, cellArea, EN, proplam0, propsigma, propbeta0, propbeta1, propsx, propsy, niter, nburn, nthin));
    return __result;
END_RCPP
}
// MCMC2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nthin(nthinSEXP);
    Rcpp::traits::input_parameter< LogicalVector >::type updates(updatesSEXP);
    __result = Rcpp::wrap(MCMC2(lam01, lam02, sigma, beta0, beta1, yboth, yleft, yright, z, X, K, D, Nfixed, knownvector, ID_L, ID_R, swap, swaptol, left, right, s, scell, psi, grid, cellArea, EN, proplam01, proplam02, propsigma, propbeta0, propbeta1, propsx, propsy, niter, nburn, nthin, updates));
    return __result;
END_RCPP
}
